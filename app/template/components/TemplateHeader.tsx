...
export default function TemplateHeader({ templates, selectedTemplateId, setSelectedTemplateId, setTemplateName, setFields, templateName, setTemplateNameHandler }: any) {
  return (
