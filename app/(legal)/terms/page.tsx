...
export default function TermsPage() {
    return (
      <div className="max-w-3xl mx-auto py-12 px-4">
        ...
        <h2 className="font-semibold text-lg mt-6 mb-2"> • Use of Service</h2>
        ...
        <h2 className="font-semibold text-lg mt-6 mb-2"> • Account and Access</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="font-semibold text-lg mt-6 mb-2"> • Liability</h2>
